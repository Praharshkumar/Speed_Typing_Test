...
class TypingTest:
	...
	def go_backward(self, backward, forward, title, place_holder)  -> None:
	...
	def show_typing_result(self) -> None:
		...
		result = Label(self.current_frame, text = "Result", fg = 'black', bg = 'skyblue1', font= 'Lucida\ Calligraphy 26 underline')
		...
		lb_actual_accuracy = Label(self.current_frame, text = 'Actual Accuracy', fg = 'black', bg = 'LightSalmon2', font= 'Lucida\ Fax 22')
		lb_actual_accuracy.grid(row = 2, column = 0, pady = (25, 0))
		accuracy_actual_val = Label(self.current_frame,text= f'{actual_accuracy}%', fg = 'red', bg = 'khaki', font = 'Lucida\ Fax 22 bold')
		...
		lb_exit = Button(self.current_frame, text = 'EXIT', fg = 'red', bg = 'plum1', font= 'Verdana\ Pro 18 bold', borderwidth = 3, command = self.get_exit)
		lb_exit.grid(row = 5, column = 1, pady = 50, padx = 30)
		lb_home = Button(self.current_frame, text = 'HOME', fg = 'red', bg = 'plum1', font= 'Verdana\ Pro 18 bold', borderwidth = 3, command = self.back_to_home)
	...
	def start_typing(self) -> None:
		...
		title = Label(self.current_frame, fg = 'black', bg = 'white', text = self.topic.get(), font = 'Lucida\ Console 26 underline')
		...
		place_holder = Message(self.current_frame, text = self.paragraph, fg = 'black', bg = 'ivory3', width = 1000, justify = 'center', font = 'Verdana\ Pro 18')
		place_holder.grid(row= 2, column = 0, columnspan = 3,padx = 80, pady = 40)
			
		self.user_input = Text(self.current_frame, width = 80, height = 10, bg = 'floral white', fg = 'black', insertbackground = 'green', borderwidth = 5, relief = RAISED, padx = 5, pady = 5, font= 'Verdana\ Pro 16')
	...
	def set_typing_home(self) -> None:
		...
		start_test = Button(self.current_frame, text = "Start Test", font = 'Verdana\ Pro 15', borderwidth = 3, bg = 'lightblue1', fg = 'black', relief = RAISED, command = self.start_typing)
